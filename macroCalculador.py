...
class MacroSeccao:
    ...
    def __init__(self,njoyOutput,material, elementos):
    ...
    def calculaNI(self):
        ...
        with open(self.ingredientes,'r') as self.ingredientes:
            ...
            for elemento in self.ingredientes:
                elemento = elemento.split()

                fracoes.append(elemento[-1])#Pega a fração de peso
                elementosMaterial.append(elemento[0]) #Pega o elemento que compõe o material
        ...
        for massa in elementosMaterial:
            ...
            try:
                peso = elementos[elementos.index(massa) + 1]                
